...
public class PackagesAndLayers {
    ...
    public static final String BOOTSTRAP_PACKAGE = "fr.cleancode.org.bootstrap..";
    public static final String DOMAIN_PACKAGE = "fr.cleancode.org.domain..";
    public static final String CLIENT_PACKAGE = "fr.cleancode.org.client..";
    public static final String REST_ADAPTER_PACKAGE =
            "fr.cleancode.org.client.rest..";
    public static final String SERVER_PACKAGE = "fr.cleancode.org.server..";
    public static final String POSTGRES_ADAPTER_PACKAGE =
            "fr.cleancode.org.server.postgres..";
