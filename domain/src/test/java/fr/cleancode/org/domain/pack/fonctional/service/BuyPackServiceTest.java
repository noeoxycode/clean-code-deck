...
//public class BuyPackServiceTest {
//
//    @Mock
//    private PlayerFinderSpieSpi spi;
//
//    @Mock
//    private PackContentGeneratorService packContentGeneratorService;
//
//    @InjectMocks
//    private BuyPackService buyPackService;
//
//    @Test
...
//
//        List<Hero> packContent = buyPackService.buyPack(playerId, pack);
//
...
//        when(spi.findPlayerById(playerId)).thenReturn(player);
//
//        assertThrows(PaymentException.class, () -> buyPackService.buyPack(playerId, pack));
